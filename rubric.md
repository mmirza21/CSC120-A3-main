...
____YES_ 1 pt: Program queries user for number of conversation rounds
...
____YES_ 1 pt: Uses a canned response when no mirror words detected
...
____YES_ 1 pt: Prints transcript when terminating
